...
function verif_date_resevation($jour_heure_ajd, $jour_reserver, $heure_dispo){
    $jour_heure_ajd = date_suivant_nbr($jour_heure_ajd);
    $nv = $jour_heure_ajd.':'.$heure_dispo;
    foreach ($jour_reserver as $key) {
